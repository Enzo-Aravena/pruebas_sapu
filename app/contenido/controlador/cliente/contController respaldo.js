				...
				if (resultado.sesion === undefined) {
					switch(resultado[0].estado){
						...
						case '2':
							...
							$("#mensaje").empty();
							var texto='';
							texto = texto + '<h3  style="font-size:x-large !important; font-weight:600> <label>El paciente esta siento atendido por el profesional</label> <br>';
							texto = texto + '<b style="font-size: x-large!important; font-weight:900">'+resultado[0].NOMBRE_PROFESIONAL+'</b>,<br>';
							texto = texto +' Desde las <b style="font-size: medium; font-weight:900" >'+resultado[0].FECHA_HORA_BLOQUEO+' .</b></h3>';
						    $("#mensaje").append(texto);
							$('#modalValidacion').modal();
						break;
						case '3':
