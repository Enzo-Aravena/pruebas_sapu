					...
					<!-- INICIO DATOS PACIENTE -->
						<div class="form-horizontal">
							...
							<table class="table table-bordered">
								<tr>
									<td>
										<label for="nombrePaci" style="color:black; font-size:medium; font-weight:bold" for="nombrePaci"> Nombre Paciente: </label>
										<span style="color:black; font-size:medium;" id="nombrePaci" name="nombrePaci"></span>
										<span for="nombrePaci"  class="position-relative" style="display: inline-block;position: relative;">
											...
											<div style="position:absolute !important" class="position-absolute d-none recuadro" id="recuadroData" style="padding: 10px;">
												<br>
												<div class="form-horizontal">
									...
									<td>
										<label for="nombrePaci" style="color:black; font-size:medium; font-weight:bold" for="sexo"> Sexo: </label>
										<span for="nombrePaci" style="color:black; font-size:medium;" id="sexo"></span>
									</td>
									<td>
										<label for="nombrePaci" style="color:black; font-size:medium; font-weight:bold" for="edadPac"> Edad: </label>
										<input class="campoTexto " id="fnac" name="fnac" type="hidden" disabled="">
										<span for="nombrePaci" style="color:black; font-size:medium;" id="edadPac"></span>
									</td>
								</tr>
								<tr>
									<td>
										<label for="nombrePaci" style="color:black; font-size:medium; font-weight:bold" for="fechIngreso"> Hora de Admisión: </label>
										<span for="nombrePaci" style="color:black; font-size:medium;" id="fechIngreso"></span>
									</td>
									<td>
										<label for="nombrePaci" style="color:black; font-size:medium; font-weight:bold" for="tipoConsulta"> Tipo de Consulta: </label>
										<span for="nombrePaci" style="color:black; font-size:medium;" id="tipoConsulta"></span>
									</td>
									<td>
										<label for="nombrePaci" style="color:black; font-size:medium; font-weight:bold"  for="motivoConsulta"> Motivo de Consulta: </label>
										<span for="nombrePaci" style="color:black; font-size:medium;" id="motivoConsulta"></span>
									</td>
								</tr>
							</table>
						</div>
						...
						<div class="form-horizontal" style="margin-top: 6px;background: #f9f9f9;display: -webkit-inline-box;border: 2px solid;width: 100%;">
							<div class="col-md-6">
								<table class="table table-bordered" style="width: 81%;background-color:#f9f9f9;">
									...
									<tr>
										<td colspan="5" style="border: none; color:black"> &nbsp;</td>
									</tr>
								</table>
							</div>
							<div class="col-md-6">
						...
						<div class="form-horizontal">
							<div style=" font-size:large!important; color:black;" class="form-group">
								...
								<br><br>
								<label class="radio-inline requiereConst" style="margin-top: -1% !important; margin-left:90px"><input name="requiereConstLesion" type="radio" value="1"><span> Si </span></label>
							...
							<div class="col-md-6" id="constatacionDeLesionesUno">
								<table class="table table-bordered" style="border:1px solid black;width:100% !important;border-radius:5px;">
									<tr><td colspan="3" style="font-size:x-large; color:black;">  Método del Diagnóstico</td></tr>
			                        <tr>
			                            <td colspan="3">
			                                <label><input  type="checkbox" id="examenFisicoConst" name="examenFisicoConst"><span style="font-size:large;"> Examen Físico </span></label>
											<br>
											<label><input type="checkbox" id="imagenConst" name="imagenConst"><span style="font-size:large;"> Imagenología </span></label>
											<br>
											<label><input type="checkbox" id="exLabConst" name="exLabConst"><span style="font-size:large;"> Examenes de Laboratorio</span></label>
											<br>
											<label><input type="checkbox" id="otrosConst" name="otrosConst"><span style="font-size:large; "> Otros </span></label>
			                            </td>
			                        </tr>
			                        <tr>
			                            <td colspan="3"> </td>
			                        ...
			                        <tr>
			                            <td colspan="3"> 
											...
											<textarea style="width: 31em; color:#f9f9f9!important;" class="form-control textareaResize " maxlength="700" id="origenLesionRelatoLesionado" name="origenLesionRelatoLesionado" rows="2" cols="2"></textarea>
											<p id="numRelatoLesion">0/700</p>
			                            </td>
			                        </tr>
			                        <tr>
			                            <td colspan="3">
			                            	<label for="origenLesionClinica" style="font-size: medium; font-weight:600"> Según relato apreciación clínica (Ej. : Caída de altura, objeto contundente. No puede el médico certificar la intencionalidad de <br>
			                        ...
			                        <tr>
			                        	<td colspan="3" style="font-size: medium; font-weight:600">
			                        		...
			                        		<br>
			                                <label style="font-size: medium; font-weight:500; color:black;">
			                        ...
			                        <tr>
			                        	<td colspan="3" style="font-size: medium; font-weight:600">  Diagnóstico Médico Legal de las lesiones: 
							...
							<div class="col-md-6" id="constatacionDeLesionesDos">
								<table class="table table-bordered" style="border:1px solid black;width:100% !important;border-radius:5px;">
									<tr>
			                            <td colspan="3" style="font-size: medium; font-weight:600">  Lesionado viene acompañado:</td>
			                        </tr>
			                        <tr>
			                            <td colspan="3">
											<label class="radio-inline examenFisico" style="margin-top: -1% !important;"><input id="vieneAcompanadoSi" name="vieneAcompanado" type="radio" value="1"><span style="font-size: medium; font-weight:600"> Si </span></label>
											<label class="radio-inline examenFisico" style="margin-top: -1% !important;"><input id="vieneAcompanadoNo" name="vieneAcompanado" checked="" type="radio" value="0"><span style="font-size: medium; font-weight:600"> No </span></label>
			                            </td>
			                        </tr>
			                        <tr>
			                        ...
			                        <tr>
			                            <td colspan="3"> 
											...
											<input style="width: 30em;" id="CalidadAcompLesionado" placeholder="(Pariente, funcionario de carabineros, ambulancia, vecino, etc.)" name="CalidadAcompLesionado" type="text">
			                            </td>
			                        </tr>
									<tr><td></td></tr>
								</table>
						...
						<div class="form-horizontal">
							...
							<table class="table table-bordered" >
								<tr>
									<td style="border: none">
										<label><input type="checkbox" id="Alcoholemia" name="Alcoholemia" ><span style="font-size: medium; font-weight:600" > Alcoholemia </span></label>
										<label>&nbsp; &nbsp; Nº Frasco </label>
										<input id="nFrasco" name="nFrasco" style="width: 7em;border: 1px solid #ccc !important;font-size: medium; font-weight:600 " maxlength="18" type="text" >
									</td>
								...
								<div class="col-md-6">
									<table class="table table-bordered" style="width: 95%;">
										<tbody>
											...
											<tr>
												<td>
													<span style="font-weight: bold;color: #856404; background-color: #fff3cd; border-color: #ffeeba; margin-left: 9%; font-size: medium; font-weight:900"> * Importante: "En caso de efectuar un examen físico seleccione SI y describa el resultado"</span>
												</td>
											</tr>
											<tr>
												<td style="border: none"><label style="margin-left: 28em;position: static; font-size: medium; font-weight:600"> Describa </label></td>
											</tr>
											<tr>
												<td style="border: none">
								...
								<div class="col-md-6">
									<table class="table table-bordered">
										...
										<tbody  id="MostrarManejoYtto" style="border-top: none;">
											<tr>
												<td style="border: none">
													<label for="indicaciones" style="font-size: medium; font-weight:600"> Manejo y tratamiento de indicado en SAPU/SAR (*) </label><br>
													<div class="form-group">
														<label class="control-label col-md-1" style="font-size: medium; font-weight:600">Ind. 1</label>
														<div class="col-md-9">
													...
													<div class="form-group">
														<label class="control-label col-md-1" style="font-size: medium; font-weight:600">Ind. 2</label>
														<div class="col-md-9">
														<div class="col-md-2" style="margin-right: 6%;">
													...
													<div class="form-group">
														<label class="control-label col-md-1" style="font-size: medium; font-weight:600">Ind. 3</label>
														<div class="col-md-9">
															<div class="col-md-2" style="margin-right: 6%;">
											...
											<tr>
												<td style="border: none">
													<label style="margin-left: 6.5em; font-size: medium; font-weight:600" >Especifique</label>
												</td>
											</tr>
											<tr>
												<td style="border: none">
													<label><input type="checkbox" id="radiografia" name="radiografia" >
														<span style="font-size: medium; font-weight:600"> Radiografía </span>
													</label>
											...
											<tr>
												<td style="border: none">
													<label><input type="checkbox" id="ExamenSangre" name="ExamenSangre" >
														<span style="font-size: medium; font-weight:600"> Exámenes </span>
													</label>
											...
											<tr>
												<td style="border: none">
													<label><input type="checkbox" id="ecg" name="ecg" >
														<span style="font-size: medium; font-weight:600"> ECG </span>
													</label>
												</td>
											</tr>
										</tbody>
									...
									<table class="table" style="width: 66%;">
										...
										<tr>
											<td id="seEnviaConsultaPara" style="font-size: medium; font-weight:600"> Se envía a consulta para <br>
												<label><input type="checkbox" id="confirmacioDiagnostica" name="confirmacioDiagnostica" ><span style="font-size: medium; font-weight:600"> Confirmación Diagnóstica </span></label>
												<label><input type="checkbox" id="realizarTto" name="realizarTto" ><span style="font-size: medium; font-weight:600">  Realizar tratamiento </span></label>
												<label><input type="checkbox" id="Seguimiento" name="Seguimiento" ><span style="font-size: medium; font-weight:600"> Seguimiento </span></label>
												<label><input type="checkbox" id="otraConsulta" name="otraConsulta" ><span style="font-size: medium; font-weight:600"> Otro </span></label>
	                                            <br>	                                            
										...
										<tr>
											<td style="border: none">
												<label for="grupoDiagnostico" class="control-label col-md-6" style="text-align: left; font-size: medium; font-weight:600" > GRUPO DIAGNOSTICO (DEIS) (*)</label>
												<select class="form-control" id="grupoDiagnostico" name="grupoDiagnostico" required="">
												</select>
												<label style="color: red; font-size: medium; font-weight:600"> (*) No Olvidar Seleccionar el diagnóstico del paciente</label>
											</td>
										</tr>
										<tr>
											<td style="border: none">
												<label style="font-size: medium; font-weight:600">(*) Categorización al Egreso</label>
