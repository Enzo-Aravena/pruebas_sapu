				...
				<div class="widget-container">
					<div class="widget-content padded">
						<form class="form-horizontal" enctype="multipart/form-data" id="detalle">
							...
							<div class="form-horizontal" >
								...
								<tr>
									...
									<td>
										<label for="sexo" style="color:black; font-size:medium; font-weight:bold"> Sexo: </label>
										<span style="color:black; font-size:medium;" id="sexo"></span>
									</td>
									<td>
										<label for="edadPac" style="color:black; font-size:medium; font-weight:bold"> Edad: </label>
						...
						<div class="form-horizontal">
							...
							<div class="col-md-4">
								<button style="background-color: #016414 !important; "  type="button" class="btn btn-primary" id="IngresarProcedimiento"> Guardar Procedimiento</button>
								<button style="background-color: #900 !important;" type="button" class="btn btn-primary" id="terminarProcedimientos"> Terminar Procedimientos </button>
							</div>
						</div>
					</div>
				</div>
