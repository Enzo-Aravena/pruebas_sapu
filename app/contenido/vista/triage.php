			...
			<div class="col-md-12">
				<div class="widget-container">
					<div class="widget-content padded">
						...
						<!-- INICIO DATOS TRIAGE -->
						<div class="form-horizontal" style="margin-top: 6px;background: #f9f9f9;border: 2px solid;">
							<label><b style="color:black; font-size:large;">Triage Paciente</b></label>
							<table class="table table-bordered" style="width: 60%; background-color:#f9f9f9">
								<tr>
						...
						<div class="form-horizontal" style="margin-top: 6px;background: #f9f9f9;border: 2px solid;">
							<label><b style="color:black; font-size:large;"> Antecedente Mórbidos </b></label>
							<table class="table table-bordered" style="width: 60%; background-color:#f9f9f9">
								<tr>
									<td style="border: none" >
										<div class="col-md-9" style="width:auto;" >
											<label style=" color:black !important" class="checkbox-inline"><input type="checkbox" id="HTA" name="HTA" ><span style=" color:black !important"> HTA </span></label>
											<label style=" color:black !important" class="checkbox-inline"><input type="checkbox" id="DM2" name="DM2" ><span style=" color:black !important"> DM2 </span></label>
											<label style=" color:black !important" class="checkbox-inline"><input type="checkbox" id="EPOC" name="EPOC" ><span style=" color:black !important"> EPOC </span></label>
											<label style=" color:black !important" class="checkbox-inline"><input type="checkbox" id="ASMA" name="ASMA" ><span style=" color:black !important"> ASMA </span></label>
											<label style=" color:black !important" class="checkbox-inline"><input type="checkbox" id="IRC" name="IRC" > <span style="color:black !important"> IRC </span></label>
											<label style=" color:black !important" class="checkbox-inline"><input type="checkbox" id="DHC" name="DHC" > <span style="color:black !important"> DHC </span></label>
											<label style=" color:black !important" class="checkbox-inline"><input type="checkbox" id="OTRAS" name="OTRAS" > <span style="color:black !important"> OTRAS EC </span></label>
											<label><input style="border: none; color:black" id="otrosEcDescrip" placeholder="Describa.." name="otrosEcDescrip" maxlength="30" type="text"></label>
										</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td style="border: none">
										<label class="control-label col-md-2" style="width: 10em; color:black; font-size:large;"> Categorización: (*)</label>
										<div class="col-md-10">
											<label style="color:black" class="radio-inline Mostrar"><input name="categorizacion" type="radio" value="C1"><span> C 1</span></label>
											<label style="color:black" class="radio-inline Mostrar"><input name="categorizacion" type="radio" value="C2"><span> C 2 </span></label>
											<label style="color:black" class="radio-inline Mostrar"><input name="categorizacion" type="radio" value="C3"><span> C 3</span></label>
											<label style="color:black" class="radio-inline Mostrar"><input name="categorizacion" type="radio" value="C4"><span> C 4 </span></label>
											<label style="color:black" class="radio-inline Mostrar"><input name="categorizacion" type="radio" value="C5"><span> C 5 </span></label>
										</div>
									</td>
								</tr>
								<tr>
