...
<head>
	...
	<script 
	src="../controlador/cliente/contController.js?id=99">
	</script>
	<script
	 src="js/navDashboard.js?id=97">
	</script>
							...
							<div class="row">
								<div class="col-md-2">
									<div class="widget-container fluid-height">
										<button type="button" class="btn btn-danger" id="volverSeleccionCentro" style="background-color: grey !important; font-size:large;"> Volver a Selección Centro </button>	
									</div>
								</div>
								...
								<div class="tab_content" id="tab3">
									...
									<div>
							            <div class="col-md-7 categorizacion" >
							            	<label style="font-size: large; color:#000;">Leyenda Categorización : </label>
										...
										<div class="form-group">
							          	...
							          	<div class="form-group">
								            ...
								            <div class="col-md-3">
											 ...
											 <button class="btn btn-primary" id="buscarPacientesDadosDeAlta" style="display: inline-block; background-color: #016414 !important;">Buscar Paciente</button>
							          	</div>
							        </div>
									<br>
										...
										<div class="form-group">
							          	...
							          	<div class="form-group">
								            ...
								            <div class="col-md-3">
											 ...
											 <button class="btn btn-primary" id="buscarPacientesCancelados" name="buscarPacientesCancelados" style="display: inline-block; background-color: #016414 !important;">Buscar Paciente</button>
							          	</div>
							        </div>
