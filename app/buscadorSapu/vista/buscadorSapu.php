				...
				<div class="widget-content padded">
					<div class="form-horizontal">
						<div class="widget-container fluid-height">
							<button style="background-color: grey !important; font-size:large;" type="button" class="btn btn-danger"  id="volverSeleccionCentro" > Volver a Seleccion Centro </button>	
						</div>						
					</div>
